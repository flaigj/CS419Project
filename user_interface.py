...
#Welcome screen
def welcome():
	print "Welcome to Group 9's Project"
	print "Choose one of the following options\n"
	print "1) View OSU course info from OSU's catalog"
	print "2) Meeting Scheduler\n"

	option = getNumber(1, 2)			# get number between 1 and 3
	return option
